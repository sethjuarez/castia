...
Start local. Run the smallest test or eval that proves the agent handles the main scenario. If a Castia canvas or local chat surface exists, use it after tests pass and record one short transcript.
