...
"####;
    let instance: AgentConfigResolution =
    ...
    assert_eq!(
        instance,
        AgentConfigResolution::load_from_value(&canonical, &LoadContext::default()),
    ...
    let reparsed: AgentConfigResolution =
...
fn test_agent_config_resolution_from_json_invalid() {
    let ctx = LoadContext::default();
    assert!(
        AgentConfigResolution::from_json("{", &ctx).is_err(),
