...
"####;
    ...
    assert_eq!(
        instance,
        Activity::load_from_value(&canonical, &LoadContext::default()),
    ...
    let reparsed: Activity = serde_json::from_value(value).expect("serde should re-deserialize");
