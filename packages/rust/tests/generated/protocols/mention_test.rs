...
"####;
    ...
    assert_eq!(
        instance,
        Mention::load_from_value(&canonical, &LoadContext::default()),
    ...
    let reparsed: Mention = serde_json::from_value(value).expect("serde should re-deserialize");
