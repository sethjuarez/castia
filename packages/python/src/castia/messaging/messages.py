...
from castia.hosting.identity import agentic_user_id, require_agentic_user
...
class Message:
    ...
    async def say(
        ...
        * ``entities`` -- raw extra entities (e.g. an
        ...
        """
        from castia.messaging.connector import post_activity
        from castia.runtime.context import current_turn_or_none, decorate_message
    ...
    async def typing(self) -> None:
        ...
        from castia.messaging.connector import send_typing
    ...
    async def react(self, reaction: str = "like") -> bool:
        ...
        from castia.messaging.connector import add_reaction
    ...
    async def unreact(self, reaction: str = "like") -> bool:
        ...
        from castia.messaging.connector import remove_reaction
    ...
    async def update(self, activity_id: str, text: str, **payload: Any) -> bool:
        ...
        from castia.messaging.connector import update_activity
    ...
    async def delete(self, activity_id: str) -> bool:
        ...
        from castia.messaging.connector import delete_activity
